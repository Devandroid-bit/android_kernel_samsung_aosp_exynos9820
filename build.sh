...
AK3_REPO="https://github.com/Lordify97/Anykernel.git"
TOOLCHAIN_DIR="/home/$USER/Android/ToolChain/ZyClang-23/"
...
package_kernel() {
    ...
    sed -i "/device.name1=.*/c\device.name1=$device" $AK3_DIR/anykernel.sh
